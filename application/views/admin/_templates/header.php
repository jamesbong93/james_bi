...
?>
<!doctype html>
<html lang="<?php echo $lang; ?>" ng-app="BiApp">
    <head>
...
<?php endif; ?>
        ...
        <!-- loading spinner css -->
        <link type="text/css" rel="stylesheet" href="<?php echo base_url($frameworks_dir .'/loading-spinner.css');?>" >
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo base_url($plugins_dir .'/plupload/css/jquery.ui.plupload.css');?>" media="screen" />
        <!--End Plupload-->
        ...
        <script type="text/javascript" src="<?php echo base_url($frameworks_dir . '/angular/angular.min.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo base_url($frameworks_dir . '/angular-translate/angular-translate.min.js'); ?>"></script>
...
<?php endif; ?>
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini" ng-controller="RootController as rootCtrl">
