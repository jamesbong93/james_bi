...
class Ion_auth
{
	...
	public function is_senior($id=false)
	{
		$this->ion_auth_model->trigger_events('is_senior');

		$senior_group = $this->config->item('senior_group', 'ion_auth');

		return $this->in_group($senior_group, $id);
	}
	/**
	 * in_group
	 *
