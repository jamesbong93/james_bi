...
class Template {
    ...
    public function senior_render($content, $data = NULL)
    {
        if ( ! $content)
        {
            return NULL;
        ...
        {
            $this->template['header']          = $this->CI->load->view('senior/_templates/header', $data, TRUE);
            $this->template['main_header']     = $this->CI->load->view('senior/_templates/main_header', $data, TRUE);
            $this->template['main_sidebar']    = $this->CI->load->view('senior/_templates/main_sidebar', $data, TRUE);
            $this->template['content']         = $this->CI->load->view($content, $data, TRUE);
            $this->template['control_sidebar'] = $this->CI->load->view('senior/_templates/control_sidebar', $data, TRUE);
            $this->template['footer']          = $this->CI->load->view('senior/_templates/footer', $data, TRUE);

            return $this->CI->load->view('senior/_templates/template', $this->template);
        }
    }
