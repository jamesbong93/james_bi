...
class Users extends Admin_Controller {
    ...
    public function __construct()
    {
        ...
        /* Breadcrumbs :: Common */
        $this->breadcrumbs->unshift(1, 'Users', 'admin/users');
    }
	...
	{
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Create', 'admin/users/create');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
	...
	public function edit($id)
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Edit', 'admin/users/edit');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
	...
	public function deactivate($id = NULL)
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Deactivate', 'admin/users/deactivate');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
	...
	{
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Profile', 'admin/groups/profile');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
